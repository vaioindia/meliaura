...
function cosmetista_related_products_args($args) {
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
			...
			<div class="cmsmasters_product_title_info_wrap">
				...
				if (get_the_terms($product->get_id(), 'product_cat')) {
					echo '<div class="cmsmasters_product_cat entry-meta">' . 
						cosmetista_get_the_category_list($product->get_id(), 'product_cat', ', ', esc_html('in', 'cosmetista') . ' ') . 
					'</div>';
				}
	...
	<?php
		if ($cmsmasters_layout != 'fullwidth') {
			add_filter('woocommerce_output_related_products_args', 'cosmetista_related_products_args');
		}
