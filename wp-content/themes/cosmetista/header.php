...
<?php cosmetista_get_header_search_form($cmsmasters_option); ?>

<!-- Start Page  -->
<div id="page" class="<?php cosmetista_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<?php 
cosmetista_page_heading();


list($cmsmasters_layout, $cmsmasters_page_scheme) = cosmetista_theme_page_layout_scheme();
