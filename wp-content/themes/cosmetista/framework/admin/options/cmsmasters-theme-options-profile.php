...
if (!function_exists('cosmetista_get_custom_profile_meta_fields')) {
function cosmetista_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['cosmetista' . '_profile_post_title']) && $cmsmasters_option['cosmetista' . '_profile_post_title'] !== '') ? (($cmsmasters_option['cosmetista' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['cosmetista' . '_profile_post_details_title']) && $cmsmasters_option['cosmetista' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['cosmetista' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['cosmetista' . '_profile_post_share_box']) && $cmsmasters_option['cosmetista' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['cosmetista' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'cosmetista'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'cosmetista'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'cosmetista'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'cosmetista'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'cosmetista'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'cosmetista'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'cosmetista'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'cosmetista'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'cosmetista'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'cosmetista'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'cosmetista'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'cosmetista'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'cosmetista'), 
			'desc'	=> '', 
