...
if (!function_exists('cosmetista_get_custom_page_meta_fields')) {
function cosmetista_get_custom_page_meta_fields() {
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['cosmetista' . '_header_overlaps']) && $cmsmasters_option['cosmetista' . '_header_overlaps'] !== '') ? (($cmsmasters_option['cosmetista' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'cosmetista'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'cosmetista'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'cosmetista'), 
