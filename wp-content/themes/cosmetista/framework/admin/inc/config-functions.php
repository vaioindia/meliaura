...
if (!function_exists('cmsmasters_fonts_list')) {
	function cmsmasters_fonts_list() {
		...
		if (isset($cmsmasters_option['cosmetista' . '_google_web_fonts']) && is_array($cmsmasters_option['cosmetista' . '_google_web_fonts'])) {
			$google_web_fonts_array = $cmsmasters_option['cosmetista' . '_google_web_fonts'];
...
if (!function_exists('cmsmasters_text_transform_list')) {
	function cmsmasters_text_transform_list() {
		$list = array( 
			...
			'uppercase' => esc_html__('uppercase', 'cosmetista'), 
			'lowercase' => esc_html__('lowercase', 'cosmetista'), 
			'capitalize' => esc_html__('capitalize', 'cosmetista'), 
		);
...
if (!function_exists('cmsmasters_image_thumbnail_list')) {
	function cmsmasters_image_thumbnail_list() {
		$list = cosmetista_get_image_thumbnail_list();
...
if (!function_exists('cmsmasters_color_schemes_list')) {
	function cmsmasters_color_schemes_list() {
		$list = cosmetista_all_color_schemes_list();
