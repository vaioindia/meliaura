...
function cosmetista_slider_post_heading($cmsmasters_id, $type = 'post', $tag = 'h1', $link_redirect = false, $link_url = false, $show = true, $link_target = false) { 
	if ($type == 'post') {
...
function cosmetista_slider_post_exc_cont($type = 'post', $show = true) {
	if ($type == 'post') {
...
function cosmetista_slider_post_check_exc_cont($type = 'post') {
	$exc = cosmetista_slider_post_exc_cont($type, false);
...
function cosmetista_get_slider_post_date($type = 'post', $show = true) {
	if ($type == 'post') {
...
function cosmetista_get_slider_post_author($type = 'post', $show = true) {
	if ($type == 'post') {
		$out = '<span class="cmsmasters_slider_post_author">' . 
			'<span class="cmsmasters_preposition">' . esc_html__('by', 'cosmetista') . ' ' . '</span>' . 
			'<a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '" title="' . esc_attr__('Posts by', 'cosmetista') . ' ' . esc_attr(get_the_author_meta('display_name')) . '" class="vcard author" rel="author"><span class="fn">' . esc_html(get_the_author_meta('display_name')) . '</span></a>' . 
		'</span>';
	} elseif ($type == 'project') {
		$out = '<span class="cmsmasters_slider_project_author">' . 
			'<span class="cmsmasters_preposition">' . esc_html__('by', 'cosmetista') . ' ' . '</span>' . 
			'<a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '" title="' . esc_attr__('Projects by', 'cosmetista') . ' ' . esc_attr(get_the_author_meta('display_name')) . '" class="vcard author" rel="author"><span class="fn">' . esc_html(get_the_author_meta('display_name')) . '</span></a>' . 
		'</span>';
	}
...
function cosmetista_get_slider_post_category($cmsmasters_id, $taxonomy, $type = 'post', $show = true) {
	$out = '';
...
function cosmetista_slider_post_like($type = 'post', $show = true) {
	$out = '';
...
function cosmetista_get_slider_post_comments($type = 'post', $show = true) {
	$out = '';
	
	
	if (comments_open()) {
		if ($type == 'post') {
			$out = cosmetista_get_comments('cmsmasters_slider_post_comments');
		} elseif ($type == 'project') {
			$out = cosmetista_get_comments('cmsmasters_slider_project_comments');
		}
	}
...
function cosmetista_slider_post_more($cmsmasters_id, $show = true) {
	$cmsmasters_post_read_more = get_post_meta($cmsmasters_id, 'cmsmasters_post_read_more', true);
	
	
	if ($cmsmasters_post_read_more == '') {
		$cmsmasters_post_read_more = esc_attr__('Read More', 'cosmetista');
	}
...
/* Get Posts Slider Like Function */
function cosmetista_slider_post_views($type = 'post', $show = true) {
	$out = '';
	
	
	if ($type == 'post') {
		$out = cmsmastersView('cmsmasters_slider_post_views', '', 'true');
	} elseif ($type == 'project') {
		$out = cmsmastersView('cmsmasters_slider_project_views', '', 'true');
	}
