...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Reviews', 'cosmetista');

$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'cosmetista');

$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'cosmetista');

$sorting_name_text = ($sorting_name_text != '') ? $sorting_name_text : esc_html__('Name', 'cosmetista');

$sorting_date_text = ($sorting_date_text != '') ? $sorting_date_text : esc_html__('Date', 'cosmetista');
