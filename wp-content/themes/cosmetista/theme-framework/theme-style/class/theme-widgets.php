...
class WP_Widget_Custom_Contact_Info extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_html__('Your contact information', 'cosmetista') 
		);
		...
		parent::__construct('custom-contact-info', esc_attr__('Contact Information', 'cosmetista'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Contact Information', 'cosmetista') : $instance['title'], $instance, $this->id_base);
		...
		if ( 
			...
			echo '<span class="adr adress_wrap contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('Address:', 'cosmetista') . '</span><span class="contact_info_item_desc">';
		}
		...
		if ($time != '') { 
            echo '<span class="contact_widget_time contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('Time:', 'cosmetista') . '</span>' . 
		...
		if ($name != '') { 
            echo '<span class="contact_widget_name  contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('Name:', 'cosmetista') . '</span>' . 
        ...
        if ($url != '') { 
            echo '<span class="contact_widget_url contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('URL:', 'cosmetista') . '</span>' . 
        ...
        if ($email != '') { 
            echo '<span class="contact_widget_email contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('Email:', 'cosmetista') . '</span>' . 
		...
		if ($phone != '') { 
            echo '<span class="contact_widget_phone contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('Phone:', 'cosmetista') . '</span>' . 
    ...
    function form($instance) {
        ...
        ?>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title', 'cosmetista'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('name')); ?>"><?php esc_html_e('Name', 'cosmetista'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('name')); ?>" name="<?php echo esc_attr($this->get_field_name('name')); ?>" type="text" value="<?php echo esc_attr($name); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('url')); ?>"><?php esc_html_e('Website', 'cosmetista'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('url')); ?>" name="<?php echo esc_attr($this->get_field_name('url')); ?>" type="text" value="<?php echo esc_attr($url); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email', 'cosmetista'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('email')); ?>" name="<?php echo esc_attr($this->get_field_name('email')); ?>" type="text" value="<?php echo esc_attr($email); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Phone', 'cosmetista'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('phone')); ?>" name="<?php echo esc_attr($this->get_field_name('phone')); ?>" type="text" value="<?php echo esc_attr($phone); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Address', 'cosmetista'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('address')); ?>" name="<?php echo esc_attr($this->get_field_name('address')); ?>" type="text" value="<?php echo esc_attr($address); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('city')); ?>"><?php esc_html_e('City', 'cosmetista'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('state')); ?>"><?php esc_html_e('State', 'cosmetista'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('zip')); ?>"><?php esc_html_e('Zip', 'cosmetista'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('country')); ?>"><?php esc_html_e('Country', 'cosmetista'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('time')); ?>"><?php esc_html_e('Time', 'cosmetista'); ?>:<br />
...
class WP_Widget_Custom_Latest_Projects extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Latest reviews', 'cosmetista') 
		);
		
		parent::__construct('custom-latest-projects', esc_attr__('Latest Reviews', 'cosmetista'), $widget_ops);
	}
	
    function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Latest Reviews', 'cosmetista') : $instance['title'], $instance, $this->id_base);
        ...
        if ($lp->have_posts()) { 
            ...
            while ($lp->have_posts()) : $lp->the_post();
				...
				echo '<div class="cmsmasters_owl_slider_item cmsmasters_slider_project">';
					...
					cosmetista_get_project_category(get_the_ID(), 'pj-categs', 'page');
					
					cosmetista_slider_post_heading(get_the_ID(), 'project', 'h3', $cmsmasters_project_link_redirect, $cmsmasters_project_link_url, true, $cmsmasters_project_link_target);
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('type')); ?>"><?php esc_html_e('Show Only from Reviews Type', 'cosmetista'); ?>:<br />
                <select id="<?php echo esc_attr($this->get_field_id('type')); ?>" name="<?php echo esc_attr($this->get_field_name('type')); ?>" class="widefat">
                    <option value=""><?php esc_html_e('Show all reviews', 'cosmetista'); ?>&nbsp;</option>
				<?php 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of latest reviews you'd like to display", 'cosmetista'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'cosmetista'); ?> 3</small><br />
            </label>
        </p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php esc_html_e('Autoplay', 'cosmetista'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_Popular_Projects extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Most popular reviews', 'cosmetista') 
		);
		
		parent::__construct('custom-popular-projects', esc_attr__('Popular Reviews', 'cosmetista'), $widget_ops);
	}
	
    function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Popular Reviews', 'cosmetista') : $instance['title'], $instance, $this->id_base);
		$type = isset($instance['type']) ? $instance['type'] : '';
		$number = isset($instance['number']) ? (int) $instance['number'] : '';
        $autoplay = isset($instance['autoplay']) ? $instance['autoplay'] : false;
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of popular reviews you'd like to display", 'cosmetista'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'cosmetista'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Posts_Tabs extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Latest, popular posts & recent comments', 'cosmetista') 
		);
		
		parent::__construct('custom-posts-tabs', esc_attr__('Posts Tabs', 'cosmetista'), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		if ($latest) {
			echo '<li class="cmsmasters_tabs_list_item current_tab">' . 
				'<a href="#"><span>' . esc_html__('Latest', 'cosmetista') . '</span></a>' . 
			'</li>'; 
		}
		
		if ($popular) {
			echo '<li class="cmsmasters_tabs_list_item' . ((!$latest) ? ' current_tab' : '') . '">' . 
				'<a href="#"><span>' . esc_html__('Popular', 'cosmetista') . '</span></a>' . 
			'</li>'; 
		}
		
		if ($recent) {
			echo '<li class="cmsmasters_tabs_list_item' . ((!$latest && !$popular) ? ' current_tab' : '') . '">' . 
				'<a href="#"><span>' . esc_html__('Comments', 'cosmetista') . '</span></a>' . 
			'</li>'; 
		}
			...
			while ($latest_query->have_posts()) : $latest_query->the_post();
				...
				if ($pt_format == 'image' || $pt_format == 'gallery') {
					...
					if (has_post_thumbnail()) {
						cosmetista_thumb(get_the_ID(), 'cmsmasters-small-thumb', true, false, false, false, false, true, false);
						...
						foreach ($attachments as $attachment) { 
							if (!isset($att_counter) && $att_counter = true) { 
								cosmetista_thumb(get_the_ID(), 'cmsmasters-small-thumb', true, false, false, false, false, true, $attachment->ID);
							}
						}
					} else {
		...
		if ($recent) {
			...
			foreach ($rcomments as $comment) {
				...
				echo '<li>' . 
					...
					' <span>' . esc_html__('on', 'cosmetista') . '</span> <a href="' . get_permalink($comment_post_ID) . '#comments" rel="bookmark">' . cmsmasters_title($comment_post_ID, false) . '</a>' . 
					'<small>' . 
						'<abbr class="published" title="' . esc_attr(get_the_time('d-m-Y')) . '">' . human_time_diff($comment_date, current_time('timestamp')) . ' ' . esc_html__('ago', 'cosmetista') . '</abbr>' . 
					'</small>' . 
    ...
    function form($instance) {
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('latest')); ?>"><?php esc_html_e('Latest Posts', 'cosmetista'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('popular')); ?>"><?php esc_html_e('Popular Posts', 'cosmetista'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('recent')); ?>"><?php esc_html_e('Recent Comments', 'cosmetista'); ?></label>
		</p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of recent comments, popular and latest posts you\'d like to display", 'cosmetista'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'cosmetista'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Twitter extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your Twitter account latest tweets', 'cosmetista') 
		);
		
		parent::__construct('custom-twitter', esc_attr__('Twitter', 'cosmetista'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Twitter', 'cosmetista') : $instance['title'], $instance, $this->id_base);
		...
		if ($user != '') {
			...
			if ($tweets != '') {
				...
				foreach ($tweets as $t) {
					echo '<li>' . "\n" . 
						'<span class="tweet_time cmsmasters_theme_icon_user_twitter">' . human_time_diff($t['time'], current_time('timestamp')) . ' ' . esc_html__('ago', 'cosmetista') . '</span>' . "\n" . 
				...
				echo '<div class="cmsmasters_notice cmsmasters_notice_error cmsmasters_theme_icon_cancel">' . "\n" . 
					'<div class="notice_content">' . "\n" . 
						'<p>' . esc_html__('Please add your Twitter API keys', 'cosmetista') . ', ' . '<a target="_blank" href="http://cmsmasters.net/twitter-functionality/">' . esc_html__('read more how', 'cosmetista') . '</a></p>' . "\n" . 
					'</div>' . "\n" . 
				'</div>' . "\n";
			}
		}
    ...
    function form($instance) {
        ...
        $number = (isset($instance['number']) && $instance['number'] != 0) ? absint($instance['number']) : 2;
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title', 'cosmetista'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('user')); ?>"><?php esc_html_e('Twitter Username', 'cosmetista'); ?>:<br />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of latest tweets you'd like to display", 'cosmetista'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'cosmetista'); ?> 2</small><br />
            </label>
        </p>
        <div class="cl"></div>
        <?php
...
class WP_Widget_Custom_Profile extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_html__('Your info from profiles', 'cosmetista') 
		);
		
		parent::__construct('custom-profile', esc_attr__('Profile', 'cosmetista'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('About Author', 'cosmetista') : $instance['title'], $instance, $this->id_base);
		...
		if ($id != '') {
			...
			if ($image != '' && $cmsmasters_profile_thumb != '') { 
				echo '<figure class="cmsmasters_img_wrap">' . 
					'<a href="' . esc_url(get_permalink($id)) . '">' . 
						get_the_post_thumbnail($id, 'cmsmasters-project-full-thumb') . 
					'</a>' . 
				'</figure>';
			}
			...
			if ($social != '') { 
				cosmetista_profile_social_icons($cmsmasters_profile_social);
			}
		}
    ...
    function form($instance) {
		...
		<p>
            <label for="<?php echo esc_attr($this->get_field_id('id')); ?>"><?php esc_html_e('Choose Profile to display', 'cosmetista'); ?>:<br />
                <select id="<?php echo esc_attr($this->get_field_id('id')); ?>" name="<?php echo esc_attr($this->get_field_name('id')); ?>" class="widefat">
                    <option value=""><?php esc_html_e('Choose...', 'cosmetista'); ?>&nbsp;</option>
				<?php 
					$queryArgs = array( 
						'posts_per_page' => 		-1, 
						'post_status' => 			'publish', 
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php esc_html_e('Profile Featured Image', 'cosmetista'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('name')); ?>"><?php esc_html_e('Profile Name', 'cosmetista'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('excerpt')); ?>"><?php esc_html_e('Profile Excerpt', 'cosmetista'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('social')); ?>"><?php esc_html_e('Profile Social Icons', 'cosmetista'); ?></label>
		</p>
        <?php
    }
}
...
class WP_Widget_Custom_Latest_Posts extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your site\'s latest Posts.', 'cosmetista') 
		);
		
		parent::__construct('custom-latest-posts', esc_attr__('Latest Posts', 'cosmetista'), $widget_ops);
	}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of latest posts you'd like to display", 'cosmetista'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'cosmetista'); ?> 3</small><br />
            </label>
        </p>
...
function cosmetista_theme_add_custom_widgets($widgets) {
...
add_filter('cmsmasters_custom_widgets_filter', 'cosmetista_theme_add_custom_widgets');
