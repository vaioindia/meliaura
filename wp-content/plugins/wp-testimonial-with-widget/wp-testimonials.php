...
if( !defined( 'WTWP_VERSION' ) ) {
	define( 'WTWP_VERSION', '2.6.2' ); // Version of plugin
}
if( !defined( 'WTWP_DIR' ) ) {
...
if( !defined( 'WTWP_PRO_LINK' ) ) {
	define( 'WTWP_PRO_LINK', 'https://www.wponlinesupport.com/wp-plugin/wp-testimonial-with-widget/?utm_source=WP&utm_medium=Testimonials&utm_campaign=Features-PRO' ); // Plugin category name
}
