                    ...
                    <div class="grid-form-row <?php echo ($i>5)?"disabled":"" ?>">
                        <div class="grid-form-row-full">
                            ...
                            <div class="grid-form-row-hover">
                                <input type="radio" class="sr-only" name="testimonial_style" id="grid-style-<?php echo $i ?>" value="<?php echo $i ?>" <?php echo ($i>5)?"disabled":"" ?> />
                                <label for="grid-style-<?php echo $i ?>"><a <?php echo ($i<=5)?'href="javascript:;"':'href="'.PRO_PLUGIN_URL.'" target="_blank" '; ?> class="testimonial-button is-hidden <?php echo ($i>5)?"disabled-class":"customize-button" ?>"><?php echo ($i<=5)?__('Customize', 'stars-testimonials'):__('Upgrade to Pro', 'stars-testimonials'); ?></a></label>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                ...
                <div class="setting-box">
                    <div class="setting-box-left">
                        ...
                        <table class="form-table">
							...
							<tr>
                                <th scope="row">
                                    <label for="enable_visitor_review"><?php echo __("Collect testimonials from your visitors") ?>:</label>
									<span class="tooltip-message">
										<span class="custom-tooltip" style="text-align:left; z-index:99999">
											<span class="tooltip-text">Collect testimonials from your website's visitors by showing a button under your testimonials widget. Your testimonials will be added once you approve them. You can also create a direct link to your clients so they can submit their testimonials.</span>
								...
								<td>
									...
									<label for="enable_visitor_review">										
										<a href="<?php echo admin_url("edit.php?post_type=stars_testimonial&page=collect_review_page") ?>" target="_blank" class="pro-feature-link"><?php echo __("Pro Feature") ?></a>
									</label>
								</td>
							</tr>
                        </table>
                    ...
                    <div class="setting-box-right">
                        ...
                        <div class="preview-buttons">
                            <a href="javascript:;" class="testimonial-button pull-left back-button" ><i class="pst-arrow-left"></i> <?php echo __("Back", 'stars-testimonials') ?></a>
                            <a href="javascript:;" class="submit-button testimonial-button" ><?php echo __("Finish", 'stars-testimonials') ?> <i class="pst-arrow-right"></i></a>
                            <div class="clearfix"></div>
                            <a href="javascript:;" class="reset-button testimonial-button" ><i class="pst-refresh"></i> <?php echo __("Reset", 'stars-testimonials') ?></a>
                        </div>
                    </div>
                    <div class="clear"></div>
                </div>
