...
class Star_testimonials_form_review_box {
    ...
    public $plugin_slug = "stars-testimonials";
        ...
        if (current_user_can('manage_options')) {
            ...
            <div
                ...
                <div class="review-box-default" id="default-review-box-<?php echo $this->plugin_slug ?>">
                    <p>
                        Hi there, it seems like <b><?php echo esc_attr($this->plugin_name) ?></b> is bringing you some
                        value, and that's pretty awesome! Can you please show us some love and
                        rate <?php echo esc_attr($this->plugin_name) ?> on WordPress? It'll only take 2 minutes of your
                        time, and will really help us spread the word
                        - <b>Gal Dubinski</b>, Co-founder <img width="30px"
                                                               src="<?php echo esc_url(plugin_dir_url(__FILE__) . "images/premio-owner.png") ?>"/>
                        <a href="javascript:;"
                           class="dismiss-btn <?php echo esc_attr($this->plugin_slug) ?>-premio-review-dismiss-btn"><span
                                class="dashicons dashicons-no-alt"></span></a>
                    </p>

                    <div class="clear clearfix"></div>
                    <ul>
                        <li><a class="<?php echo esc_attr($this->plugin_slug) ?>-premio-review-box-hide-btn"
                               href="https://wordpress.org/support/plugin/stars-testimonials-with-slider-and-masonry-grid/reviews/?filter=5"
                               target="_blank">I'd love to help :)</a></li>
                        <li><a class="<?php echo esc_attr($this->plugin_slug) ?>-premio-review-box-future-btn"
                               href="javascript:;">Not this time</a></li>
                        <li><a class="<?php echo esc_attr($this->plugin_slug) ?>-premio-review-box-hide-btn"
                               href="javascript:;">I've already rated you</a></li>
                    </ul>
                </div>
                <div class="review-thanks-box" id="review-thanks-<?php echo $this->plugin_slug ?>">
                    <button class="<?php echo $this->plugin_slug ?>-close-thanks-btn review-thanks-btn"><span
            ...
            <div class="<?php echo esc_attr($this->plugin_slug) ?>-review-box-popup">
                <div class="<?php echo esc_attr($this->plugin_slug) ?>-review-box-popup-content">
                    <button class="<?php echo esc_attr($this->plugin_slug) ?>-close-review-box-popup"><span
                            class="dashicons dashicons-no-alt"></span></button>
                    <div class="<?php echo esc_attr($this->plugin_slug) ?>-review-box-title">Would you like us to remind
            ...
            <script>
                jQuery(document).on('eady', function () {
...
$Star_testimonials_form_review_box = new Star_testimonials_form_review_box();