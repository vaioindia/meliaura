...
<?php
class Star_testimonials_affiliate_program {
    ...
    public function admin_notices() {
        if (current_user_can('manage_options')) {
            ...
            <div
                class="notice notice-info <?php echo esc_attr($this->plugin_slug) ?>-premio-affiliate <?php echo esc_attr($this->plugin_slug) ?>-premio-affiliate">
                <p>Hi there, you've been using <?php echo esc_attr($this->plugin_name) ?> for a while now. Do you know
                    that <b><?php echo esc_attr($this->plugin_name) ?></b> has an affiliate program? Join now and get
                    <b>25% lifetime commission</b> <a href="javascript:;" class="dismiss-btn"><span
                            class="dashicons dashicons-no-alt"></span> Dismiss</a></p>

                <div class="clear clearfix"></div>
                <a class="button button-primary <?php echo esc_attr($this->plugin_slug) ?>-affiliate-btn"
                   target="_blank"
                   href="https://premio.io/affiliates/?utm_source=inapp&plugin=stars-testimonials&domain=<?php echo $_SERVER['HTTP_HOST'] ?>">Tell
                    me more <span class="dashicons dashicons-arrow-right-alt"></span></a>
            </div>
            <div class="<?php echo esc_attr($this->plugin_slug) ?>-affiliate-popup">
                <div class="<?php echo esc_attr($this->plugin_slug) ?>-affiliate-popup-content">
                    <button class="<?php echo esc_attr($this->plugin_slug) ?>-close-affiliate-popup"><span
                            class="dashicons dashicons-no-alt"></span></button>
                    <div class="<?php echo esc_attr($this->plugin_slug) ?>-affiliate-title">Would you like us to remind
...
$Star_testimonials_affiliate_program = new Star_testimonials_affiliate_program();