...
Donate link: http://www.addexpiresheaders.com/pro-features/
Tags: serve static assets, efficient cache policy, expires header, expires headers, far future expiration, cache, expiry header, expiry, wp-cache, minify, gzip, speed optimization, etags
...
This plugin will help to serve static assets with an efficient cache policy which help to decrease page loading time and optimize your website for various file types.
...
= Advantages =
1) Serves static assets with an efficient cache policy.
